...
const HeadingWithPara = ({hText, pText, className, classH, classP, classD}) => {
    return (
        <div className={`${className}`}>
            ...
            <div class={`${classD}  mb-1 w-[200px] h-0.5 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-[length:200%_100%] bg-right animate-[move-bg-ltr_3s_linear_infinite]`}>
            </div>
