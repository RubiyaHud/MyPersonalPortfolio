      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          className={`
            ...
            absolute top-full left-0 w-full bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 md:static md:block md:w-auto md:bg-transparent md:dark:bg-transparent md:border-0
          `}
          id="navbar-default"
        >
